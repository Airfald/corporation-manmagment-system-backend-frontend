<template>
  <div class="corporation-detail">
    <div class="corporation-detail__header">街舞社团</div>
      ...
      <div class="mt15"><el-button type="primary">没时间了，快上车-></el-button></div>
  </div>
</template>
