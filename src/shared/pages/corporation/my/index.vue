  ...
  <div class="corporation-list">
    ...
    <div class="mt15">
      ...
      <div
        ...
        <div v-if="index === 0"><img width="320px" height="250px" src="../../../assets/images/街舞社.jpg"></div>
        <div v-else-if="index === 1"><img width="320px" height="250px" src="../../../assets/images/新闻社.jpg"></div>
        <div v-else-if="index === 2"><img width="320px" height="250px" src="../../../assets/images/篮球.jpg"></div>
        <div v-else-if="index === 3"><img width="320px" height="250px" src="../../../assets/images/击剑社.jpg"></div>
        <div v-else-if="index === 4"><img width="320px" height="250px" src="../../../assets/images/排球社.jpg"></div>
        <div v-else-if="index === 5"><img width="320px" height="250px" src="../../../assets/images/滑板.jpg"></div>
        <div v-else-if="index === 6"><img width="320px" height="250px" src="../../../assets/images/健身.jpg"></div>
        <div v-else-if="index === 7"><img width="320px" height="250px" src="../../../assets/images/音乐社.jpg"></div>
        <div v-else><img width="320px" height="250px" src="../../../assets/images/corporation.jpg"></div>
